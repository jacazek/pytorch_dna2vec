...
srun rocm-python src/train.py --number_train_workers 5 --number_devices 1 --number_validate_workers 9 --learning_rate 0.0001 --epochs 1 --window_size 7 --batch_size 20480 --kmer_size 6 --stride 3 --lr_gamma 0.5 --tag genus:zea --tag note:transformer_final_output --vocab_artifact_uri=mlflow-artifacts:/2/5b1b448e36b74d74a5f043c6605ab538/artifacts/6mer-s1-202406010300.pickle --embedding_dimensions 128
